	...
	<!-- 园区概况 -->
		...
		<div class="wx_qt_zsyz_main_con">
			<!-- <textarea   class='t'    readonly="readonly" style="border:none;width:100%;height:400px"><?php echo ($xinxi["rzxx"]); ?></textarea> -->
			 ...
			 <div id="main" style="width: 20rem;height: 300px;"></div>
			 <div id="second" style="width: 320px;height: 300px;"></div>
			 <div id="third" style="width: 320px;height: 300px;"></div>
			 <div id="fouth" style="width: 320px;height: 300px;"></div>
		</div>
		<!-- 联系我们 -->
		<div class="wx_qt_zsyz_main_con ">
			...
			<div class="wx_qt_zsyz_main_change">
				...
				<p>地址：浙江省丽水市莲都区城北街368号绿谷信息产业园一号楼302</p>
				<p>电话：0578-2200216</p>
			</div>
 ...
 <script type="text/javascript">
        ...
        var option = {
            ...
            series: [{               
                name: '销量',
                type: 'bar',
                data: [20, 24, 25, 30,32,35,38,40,20, 24, 25, 30],
                itemStyle: {
                	normal: {
                	 	color: '#6575a8'
                	 }
        ...
        myChart.setOption(option);
           ...
           // 基于准s好的dom，初始化echarts实例
        var myChart = echarts.init(document.getElementById('fouth'));
