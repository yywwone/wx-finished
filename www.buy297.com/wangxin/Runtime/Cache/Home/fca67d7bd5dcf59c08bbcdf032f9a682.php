...
<link href="/Public/home/dist/css/reset1.css" rel="stylesheet">
<!--本页CSS-->
<link href="/Public/home/dist/css/wx_qt_xqym.css" rel="stylesheet">
...
<div class="wx_qt_xqym_header_img">
	<img src="/Public/admin/uploads/xqjm_bg.png">
</div>
<div class="wx_qt_xqym_tit_box">
	<div class="wx_qt_xqym_tit">
		<img src="/Public/home/dist/images/xqym_icon1.png">
		<p>闪电响应</p>
	</div>
	<img src="/Public/home/dist/images/xqym_icon4.png" class="wx_qt_xqym_tit_icon_sx">
	<div class="wx_qt_xqym_tit">
		<img src="/Public/home/dist/images/xqym_icon2.png">
		<p>资质认证</p>
	</div>
	<img src="/Public/home/dist/images/xqym_icon4.png" class="wx_qt_xqym_tit_icon_sx">
	<div class="wx_qt_xqym_tit">
		<img src="/Public/home/dist/images/xqym_icon3.png">
		<p>售后无忧</p>
	</div>
</div>
<!--选项卡-->
	...
	<div class="wx_qt_gyslb_main_box">
		...
		<div class="wx_qt_gyslb_main_bottom">
			<div class="wx_qt_gyslb_main_bottom_main">
				...
				<?php $fw_id=I('id'); ?>
				<a href="tel:0578-2200253">电话咨询</a>
			</div>
			<div class="wx_qt_gyslb_main_bottom_main">
				<a href="<?php echo U('index/aboutc','id='.$item['id']);?>">
...
<div class="wx-zcdx-font">
	<p>申报材料递交时间截止时间为每年7月20日和次年1月
20日，原则上每年兑付两次，逾期不予受理。</p>
	<p>如有疑问，请联系我们：0578-2200216 </p>
	<p>地址：绿谷信息产业园一号楼302室</p>
</div>
<!-- yxw end -->
