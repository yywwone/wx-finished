...
// })()
    ...
    $(document).ready(function(){
        $(".Pinput").click(function(){
            ...
            if(a == 2){
                $("#ticketPiao").css('display','block'); 
                $(".corver").css('display','block'); 
                $(".puSpan .span1").click(function() {
                    $("#ticketPiao").css('display','none');
                    $(".corver").css('display','none');  
                })
                $(".puSpan .span3").click(function() {
                    $("#ticketPiao").css('display','none'); 
                    $(".corver").css('display','none'); 
                })
            }
            if(a == 1){
                $("#zhuanpiao").css('display','block'); 
                $(".corver").css('display','block'); 
                $(".puSpan .span1").click(function() {
                    $("#zhuanpiao").css('display','none'); 
                    $(".corver").css('display','none'); 
                })
                $(".puSpan .span3").click(function() {
                    $("#zhuanpiao").css('display','none'); 
